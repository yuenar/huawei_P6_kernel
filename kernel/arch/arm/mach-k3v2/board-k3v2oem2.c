...
unsigned short* synaptics_touchkey__key_map(void)
{
	return syn_touchkey_keycode;
}

unsigned short* synaptics_touchkey__key_port(void)
{
	return syn_touchkey_keycode;
}

int synaptics_touchkey__led_brightness(void)
{
	return get_touchkey_led_brightness();
}

static struct synatics_touchkey_platform syp_touchkey = {
	.attn_gpio = TOUCHKEY_INT,
    .get_key_map = synaptics_touchkey__key_map,
    .get_led_brightness = synaptics_touchkey__led_brightness,
