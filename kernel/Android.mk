...
KERNEL_CODE_GEN:
	@cd kernel/drivers/huawei/hsad;./xml2code.sh
	@cd device/hisi/customize/hsad; perl ./gen_io_cfg.pl ../../../../kernel/arch/arm/mach-k3v2/k3v2_iomux_blocks.h > /dev/null;
...
$(KERNEL_DEBUG_CONFIGFILE):FORCE
	@device/hisi/k3v2oem1/kernel-config.sh -f $(KERNEL_COMMON_DEFCONFIG) -d $(KERNEL_DEBUG_CONFIGS) -o $(KERNEL_DEBUG_CONFIGFILE)
endif
...
$(KERNEL_GEN_CONFIG_PATH): $(KERNEL_DEBUG_CONFIGFILE)
	@device/hisi/k3v2oem1/kernel-config.sh -f $(KERNEL_DEBUG_CONFIGFILE) -d $(KERNEL_PRODUCT_CONFIGS) -o $(KERNEL_GEN_CONFIG_PATH)
...
$(TARGET_PREBUILT_KERNEL): $(KERNEL_CONFIG) KERNEL_CODE_GEN
